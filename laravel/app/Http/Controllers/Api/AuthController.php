...
// Al estar en el mismo namespace (App\Http\Controllers\Api),
// no hace falta importar ApiController, pero lo dejamos explícito por claridad.
...
class AuthController extends ApiController
{
    ...
    public function login(Request $request)
    {
        ...
        try {
            // Buscamos usuario ignorando scopes para encontrarlo incluso si no filtramos por tenant
            ...
            // Comprobación de estado robusta (boolean o string)
            ...
            // Inyectamos el tenant al sistema
